...
switch (personTemp, personState1) {
case (personTemp < 32 && personState1 === 'NE'):
    NSB.MsgBox(`Wear a warm coat, hat, scarf and gloves.`)
    break;
case (personTemp >= 32 && personTemp < 50 && personState1 === 'NE'):
    NSB.MsgBox(`Wear a warm coat but you won't need a hat, scarf or gloves`)
    break;
case (personTemp >= 32 && personTemp < 50 && personState1 === 'FL'):
    NSB.MsgBox(`Wear your warmest coat, a warm hat, a scarf, and warm gloves.`)
    break;
case (personTemp >= 50 && personTemp < 70 && personState1 === 'FL'):
